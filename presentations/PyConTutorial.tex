...
\begin{frame}
\frametitle{Image Basics}
\begin{itemize}
\item Most functionality lives in the image class.
\item Image takes a single parameter, the file name.
\item Takes everything you would like. PNG, BMP, JPG, many more.
\item Can also take a URL to an image. 
\item A couple of built-ins like lenna and simplecv.
\item $img.show()$ will display the image. 
\end{itemize}
\end{frame}
\begin{frame}
% ------------------------------------------------
